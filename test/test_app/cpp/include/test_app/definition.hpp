...
#define TEST_APP_NO_MEMBERS DATACLASS_DEFINITION(\
    TEST_APP_NO_MEMBERS,\
    (test_app, no_members),\
    NONE,\
    (TEST_APP_AUTHOR)(TEST_APP_WITH_TIMESTAMPS),\
    (test_app::interface, no_members)\
)
#define TEST_APP_NO_MEMBERS_MEMBERS TEST_APP_AUTHOR_MEMBERS TEST_APP_WITH_TIMESTAMPS_MEMBERS T_MEMBERS(TEST_APP_NO_MEMBERS)
#define TEST_APP_NO_MEMBERS_CONSTRUCTORS (TEST_APP_NO_MEMBERS)
