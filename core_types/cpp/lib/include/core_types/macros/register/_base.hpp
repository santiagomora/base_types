...
BOOST_PP_COMMA_IF(i) const T_QUALNAME(T_NAMETUPLE(CM_TYPE(elem)))&
...
py::class_<T_QUALNAME(T_NAMETUPLE(TYPE_DEF)), std::unique_ptr<T_QUALNAME(T_NAMETUPLE(TYPE_DEF))>> (m, BOOST_PP_STRINGIZE(T_NAME(T_NAMETUPLE(TYPE_DEF))))\
.def(py::pickle(\
